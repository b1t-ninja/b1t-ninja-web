...
export default function HeroSection() {
  return <div className={"flex flex-col items-center justify-center mt-20 space-y-4 md:space-y-8"}>
    ...
    <h2 className={'text-l sm:text-2xl md:text-4xl lg:text:5xl xl:text:5xl'}>I am a <span
      className={'text-[var(--fg-blue)]'}>fullstack</span> software engineer based in <span>Berlin</span><br/></h2>
    <h2 className={'text-l sm:text-2xl md:text-4xl lg:text:5xl xl:text:5xl'}>Mostly dealing with <span
